...
const DashProfile = () => {
    ...
    const  uploadImage = async()=>{
        ...
        uploadTask.on('state_changed', (snapshot) => {
          ...
          (error)=>{
            setImageFileUploadError('Could not upload image (file must be less than 2MB) and Only Image Accepted');
    ...
    const handleSubmit = async (e)=>{
        ...
        if(imageFileUploading){
            setUpdateUserError("Please wait until the image has finished uploading");
            return;
        }
